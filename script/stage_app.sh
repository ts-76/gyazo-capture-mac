...
APP_IDENTIFIER="com.toma7698.GyazoCapture.dev"
DESIGNATED_REQUIREMENT="designated => identifier \"$APP_IDENTIFIER\""
...
/usr/libexec/PlistBuddy -c "Set :CFBundleIdentifier $APP_IDENTIFIER" "$APP_CONTENTS/Info.plist"
...
/usr/bin/codesign --force --sign - --timestamp=none --requirements "=$DESIGNATED_REQUIREMENT" "$APP_BUNDLE"
/usr/bin/codesign --verify --deep --strict --verbose=2 "$APP_BUNDLE"
/usr/bin/codesign --verify --deep --strict -R="identifier \"$APP_IDENTIFIER\"" "$APP_BUNDLE"
echo "$APP_BUNDLE"
